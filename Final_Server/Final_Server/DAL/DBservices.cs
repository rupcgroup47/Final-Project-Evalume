...
public class DBservices
{
    ...
    ////--------------------------------------------------------------------------------------------------
    //public int InserEvaluationAnswers(int userNum, int evalu_Part_Type, int questionnaireNum, List<dynamic> answers)
    //{
    ...
    //    cmd = CreateCommandWithSPnewEvaluAnswers("spInsertEvaluQuesFilledDetails", con, userNum, evalu_Part_Type, questionnaireNum, answers);            // create the command
    ...
    //// Create the SqlCommand using a stored procedure
    ////---------------------------------------------------------------------------------
    //private SqlCommand CreateCommandWithSPnewEvaluAnswers(String spName, SqlConnection con, int userNum, int evalu_Part_Type, int questionnaireNum, List<dynamic> answers)
    //{
    ...
    //    intListParam.SqlDbType = SqlDbType.Structured;
    //    intListParam.TypeName = "InputAnsers";
    //    cmd.Parameters.Add(intListParam);
